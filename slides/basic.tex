...
\lstdefinestyle{latexstyle}{%
    language=[LaTeX]TeX,
    keywords={subsection,subsubsection,part,chapter,paragraph,subparagraph,operatorname,DeclareMathOperator,arcsinh}
}
...
\begin{document}
    ...
    % \input{sections/03_math-tables-and-figures/_math-tables-and-figures.tex}
